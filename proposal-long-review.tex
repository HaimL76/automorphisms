...
\begin{proposition}
For all $\varphi\in{N_{r}}$, denote by $\psi$ the automorphism $\psi:=\varphi\circ\varphi_{r,n-r}(-a_{n-r,n-r})\circ\cdots\circ\varphi_{r,1}(-a_{11})\circ\varphi_{r,0}(-a_{r1})$, where $M_{1r}=(a_{ij})$ is the $(1,r)$ block of $\varphi$. Then
