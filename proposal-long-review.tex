...
In the case of pro-isomorphic zeta-functions, there are results showing that under quite restrictive conditions, $\zeta_{G,p}^{\wedge}(s)$ is uniform and satisfies a functional equation, see, for instance, \cite{BermanKlopschOnn}.\par
