...
\[\vdots\]
\[+p^{v_4-v_1-1}[1+(v_4-1)(1-p^{-1})]\mu(p^{v_1+v_2+1-v_4}\mathbb{Z}_p\setminus{p^{v_1+v_2+2-v_4}\mathbb{Z}_p})=
\]
\[
=p^{-v_3}[1+(v_1-v_3)(1-p^{-1})](p^{v_2+v_3}-p^{v_2+v_3-1})+\]
\[+p^{-v_3+1}[1+(v_1-v_3+1)(1-p^{-1})](p^{v_2+v_3-1}-p^{v_2+v_3-2})+\]
\[\vdots\]
\[+p^{v_4-v_1-1}[1+(v_4-1)(1-p^{-1})](p^{v_4-(v_1+v_2+1)}-p^{v_4-(v_1+v_2+2)})
\]
\end{document}