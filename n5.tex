...
$=\displaystyle\int_{\underline{\lambda}}I(\underline{\lambda},\underline{b},a_{33},a_{33},a_{33})(1+v_{4}(1-p^{-1}))\int_{v_{11}\geq{-(v_{2}+v_{3})}}p^{\min\{0,v_{2}+v_{11}\}}d\mu(a_{11})$, but same as earlier $\displaystyle\int_{v_{11}\geq{-(v_{2}+v_{3})}}p^{\min\{0,v_{2}+v_{11}\}}d\mu(a_{11})=p^{0}\mu(v_{11})$ 
\end{document}