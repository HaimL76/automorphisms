...
$a_{22}\lambda_{2}\lambda_{3},-a_{22}\lambda_{3}\lambda_{4},a_{22}\lambda_{1}\lambda_{2}\lambda_{3}$,

$a_{33}\lambda_{3}\lambda_{4},a_{33}\lambda_{2}\lambda_{3}\lambda_{4},a_{33}\lambda_{1}\lambda_{2}\lambda_{3}\lambda_{4}$,

$a_{21}a_{22}\lambda_{1}\lambda_{2},-a_{11}a_{33}\lambda_{2}\lambda_{3}\lambda_{4},
a_{21}a_{33}\lambda_{1}\lambda_{2}\lambda_{3}\lambda_{4}\in\mathbb{Z}_{p}$.
