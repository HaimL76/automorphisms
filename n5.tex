...
$=\displaystyle\int_{\underline\lambda}I(\underline{\lambda},\underline{c},\underline{b},a_{21},a_{33},a_{22})\displaystyle\int_{a_{11}}p^{\min\{0,v_{2}+v_{11}\}}[1+\beta(p-1)]d\mu(a_{11})$. But as we saw earlier, $p^{\min\{0,v_{2}+v_{11}\}}$.
\end{document}