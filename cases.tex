...
So we have $v_{11}\geq{-v_2-v_1}$, we have $p^{\min}\mu(a_{11})=p^{v_2}(1+v_4\rho+(v_4-v_1)\rho+(v_4-v_1)v_4\rho^2+v_4\rho+v_4^2\rho^2-\frac{v_4(v_4-1)}{2}\rho^2)$
...
(v_3+v_4-v_1)\rho+(v_3+v_4-v_1)v_4\rho^2-\frac{(v_3+v_4-v_1+1)(v_3+v_4-v_1)}{2}\rho^2).$
