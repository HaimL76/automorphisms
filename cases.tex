...
\item 
$v_4\overset{d}{\geq}v_1+v_2\overset{c}{>}v_3\overset{b}{>}{v_1}\overset{a}{\geq}v_2\overset{e}{\geq}{0}$
...
$v_2\rightarrow{b+c}$, 
$v_3\rightarrow{a+2b+c}$, 
$v_4\rightarrow{a+2b+2c+d}$, and compute series with the new variables as indices, where $a,d\geq{0}$ and $b,c\geq{1}$.
\item 
...
\item $v_1\geq{v_4}>v_3>v_2\geq{0}$
    ...
    $v_4\geq{v_2+v_3}>{v_1}\geq{v_3}>v_2\geq{0}$ (4.1.1)
    ...
    $v_4\geq{v_1+v_2}>v_3>v_1\geq{v_2}\geq{0}$ (3.1.3)
