...
0 & a_{24} & 0 & -\lambda_4\\
\end{pmatrix}\]
We observe that $\det B=-\lambda_3^3\lambda_4=0$, but we know that $\lambda_3\neq 0$ hence we must have that $\lambda_4=0$, which rules out that $\varphi(e_{34})=\lambda_3 e_{34}+\lambda_4 e_{45}+z_2$.
