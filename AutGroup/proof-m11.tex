...
\end{pmatrix}
\]
which means that we take from $A$ the columns $2$, $4$, $5$ and $9$, and since $\mathrm{det}B_1=\lambda_3^3\lambda_1=0$, but we know that $\lambda_3\neq 0$, hence we must have that $\lambda_1=0$. Replacing column $9$ by column $7$, we get another minor  \[
B_2=\begin{pmatrix}
-\lambda_3 & 0 & 0 & 0\\
0 & \lambda_3 & 0 & 0\\
0 & 0 & -\lambda_3 & 0\\
